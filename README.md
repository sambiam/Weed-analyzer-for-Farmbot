...
Version: **3.12.7** Â· Architectures: **aarch64, amd64** Â· Home Assistant Core: **2026.7+** Â· Analysis resolution: **640Ã—480 / 960Ã—720 (default) / 1280Ã—960** Â· Minimum companion integration: **2.2.0** (contract `farmbot-vision-v2`)
...
1. In Home Assistant, open **Settings â†’ Apps â†’ App store â†’ Repositories**.
