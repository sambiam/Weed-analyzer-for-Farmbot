...
Version: **3.10.0** · Architectures: **aarch64, amd64** · Home Assistant Core: **2026.7+** · Analysis resolution: **640×480 / 960×720 (default) / 1280×960** · Minimum companion integration: **2.2.0** (contract `farmbot-vision-v2`)
